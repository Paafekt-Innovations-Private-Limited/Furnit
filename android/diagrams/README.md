...
| [`rtmdet-android-flow.svg`](rtmdet-android-flow.svg) | RTMDet furniture segmentation in `GLBRoomActivity`: CameraX analysis/preview, shared ONNX Runtime backend, fast boxes-only identify, full segmentation modes, and transparent overlay on the 3D room. |
