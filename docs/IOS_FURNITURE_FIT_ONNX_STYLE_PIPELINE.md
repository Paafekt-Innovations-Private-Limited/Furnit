...
- `docs/IOS_ROOM_FURNITURE_DIMENSIONS_AND_OVERLAY.md` — Depth Anything inference dims vs legacy splat AABB, pinhole vs proportion, fitment ratios, overlay scale (`[FurnitureFitSize]` / `[FurnitureFitOverlay]`).
