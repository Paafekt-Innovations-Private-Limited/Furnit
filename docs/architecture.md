...
| Bundled samples | Shared-source USDZ data assets; Scandinavian opens portrait, Industrial opens landscape (device-unconfirmed) | Shared-source GLBs → background staging/validation → `GLBRoomActivity`; same orientations (device-unconfirmed) |
