...
function createWorker(self) {
    ...
    function processPlyBuffer(inputBuffer) {
        ...
        console.log("Bounds:", { min: [minX, minY, minZ], max: [maxX, maxY, maxZ] });
        ...
        // Return buffer AND bounds for camera setup
        return { buffer, bounds: { min: [minX, minY, minZ], max: [maxX, maxY, maxZ] } };
    }
    ...
    self.onmessage = (e) => {
        if (e.data.ply) {
            ...
            // Send buffer AND bounds back to main thread
            postMessage({ buffer: buffer, bounds: result.bounds, save: !!e.data.save });
    ...
    canvas.addEventListener(
        ...
        (e) => {
            ...
            if (e.touches.length === 1 && down) {
                ...
                inv = translate4(inv, 0, 0, 6 * (1 - dscale));
