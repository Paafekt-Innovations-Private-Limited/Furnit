...
| Licenses/attributions | `Furnit/Views/ContentView.swift` (`LicensesView`), `Furnit/Licenses/APACHE-2.0.txt`, `Furnit/Licenses/THIRD_PARTY_NOTICES.txt` |
| Tests | `FurnitTests/` |
...
| Licenses/attributions | `android/app/src/main/java/com/furnit/android/LicensesActivity.kt`, `android/app/src/main/assets/legal/`, `android/app/build.gradle` (`verifyLegalAssets`) |
