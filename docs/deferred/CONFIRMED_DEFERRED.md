...
Last reviewed: 2026-08-05. This is a documentation ledger, not an authorization to
...
| Archived experimental ML guidance | `.cursor/rules/furnit-ml.mdc` explicitly describes archived SHARP/ExecuTorch Vulkan work; current Android uses ONNX Runtime for Depth Anything/GeoCalib, FP16 LiteRT for RTMDet, and flat-photo GLB generation. | Leave archived unless that experiment is deliberately resumed; do not use it as active implementation guidance. |
