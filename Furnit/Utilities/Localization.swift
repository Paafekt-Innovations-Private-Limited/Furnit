...
enum L10n {
    ...
    enum Licenses {
        ...
        static let viewNotices = "licenses.viewNotices".localized
    ...
    enum Credits {
        ...
        static let depthAnythingTitle = "credits.depthAnythingTitle".localized
        static let depthAnythingBody = "credits.depthAnythingBody".localized
        static let geoCalibTitle = "credits.geoCalibTitle".localized
        static let geoCalibBody = "credits.geoCalibBody".localized
        static let rtmdetTitle = "credits.rtmdetTitle".localized
        static let rtmdetBody = "credits.rtmdetBody".localized
        static let metalSplatterTitle = "credits.metalSplatterTitle".localized
        static let metalSplatterBody = "credits.metalSplatterBody".localized
        static let threeTitle = "credits.threeTitle".localized
        static let threeBody = "credits.threeBody".localized
        static let hypersimTitle = "credits.hypersimTitle".localized
        static let hypersimBody = "credits.hypersimBody".localized
        static let cocoTitle = "credits.cocoTitle".localized
        static let cocoBody = "credits.cocoBody".localized
