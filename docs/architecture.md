...
| Furniture Fit | RTMDet Core ML → class-aware NMS → mask affinity → transparent overlays | RTMDet ONNX Runtime → boxes-only identify or mask segmentation → transparent overlays |
